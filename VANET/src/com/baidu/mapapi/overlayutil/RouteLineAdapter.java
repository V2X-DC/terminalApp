    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (mtype) {
            ...
            case BIKING_ROUTE:
                ...
                if ( time / 3600 == 0 ) {
                    holder.lightNum.setText( "大约�?要：" + time / 60 + "分钟" );
                } else {
                    holder.lightNum.setText( "大约�?要：" + time / 3600 + "小时" + (time % 3600) / 60 + "分钟" );
                }
            ...
            case DRIVING_ROUTE:
                ...
                holder.dis.setText("拥堵距离为：" + drivingRouteLine.getCongestionDistance() + "�?");
                break;
            case MASS_TRANSIT_ROUTE:
                ...
                holder.dis.setText("总票价：" + massTransitRouteLine.getPrice() + "�?");
                break;
